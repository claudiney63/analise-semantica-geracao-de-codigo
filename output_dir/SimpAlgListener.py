...
class SimpAlgListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by SimpAlgParser#terminal.
    def enterTerminal(self, ctx:SimpAlgParser.TerminalContext):
        pass

    # Exit a parse tree produced by SimpAlgParser#terminal.
    def exitTerminal(self, ctx:SimpAlgParser.TerminalContext):
        pass
